...
// Instead of dynamic canvas texts, we map to explicit downloaded image files, 
// using a placeholder for the ones that couldn't be downloaded directly
const getImagePaths = (name: string) => {
  const fileMappings: Record<string, string> = {
    "selenium": "Selenium.png",
    "webdriverio": "Webdriverio.png",
    "rest-assured": "RestAssured.jfif",
    "postman": "Postman.jfif",
